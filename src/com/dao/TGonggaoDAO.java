...
public class TGonggaoDAO extends HibernateDaoSupport
{
	...
	// property constants
	public static final String GONGGAO_TITLE = "biaoti";

	public static final String GONGGAO_CONTENT = "neirong";

	public static final String GONGGAO_FABUZHE = "shijian";
	...
	public List findAll()
	{
		...
		try
		{
			String queryString = "from TGonggao order by id desc";
